...
<p align="center">
<img src="https://github.com/AdvAttack/TCCANet-TKDE/blob/main/image/fig-framework.png" width=100% height=100%>
</p>

## Usage

* Download the preprocessed multiview feature of RSSCN7 datasets from [Google Drive](https://drive.google.com/file/d/1ZAnZYALuPyS5KpZHTfAeOQx7v0p0cWAg/view?usp=sharing) and place them in `/TCCANet`.
